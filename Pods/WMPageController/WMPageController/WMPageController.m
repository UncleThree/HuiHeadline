...
//        CGFloat originY = (self.showOnNavigationBar && self.navigationController.navigationBar) ? 0 : CGRectGetMaxY(self.navigationController.navigationBar.frame);
        ...
        //change
        _menuViewFrame = CGRectMake(0, 0, self.view.frame.size.width - 40, 40.0f);
    }
...
- (void)wm_addAddVButton {
    ...
    UIButton *add = [[UIButton alloc] initWithFrame:CGRectMake(UIScreen.mainScreen.bounds.size.width - 40, 0, 40, 40)];
    [add setTitle:@"+" forState:UIControlStateNormal];
    [add addTarget:self action:@selector(channelList) forControlEvents:UIControlEventTouchDown];
    add.backgroundColor = [UIColor colorWithWhite:0.9 alpha:1.0];
