...
@protocol WMAddButtonDelegate <NSObject>
 ...
 *
 *    pageController The parent controller.
 *
 ...
 *
 *    pageController The parent controller.
 *    index          The index of child controller.
 *
...
/**
 Implement this datasource method, in order to customize your own contentView's frame
   ...
   pageController The container controller
   contentView The contentView, each is the superview of the child controllers
 ...
 *
 *    pageController The parent controller (WMPageController)
 *    viewController The viewController first show up when scroll stop.
 *    info           A dictionary that includes some infos, such as: `index` / `title`
 */
 ...
 *
 *    pageController The parent controller (WMPageController)
 *    viewController The viewController will be cached.
 *    info           A dictionary that includes some infos, such as: `index` / `title`
 */
 ...
 *
 *    pageController The parent controller (WMPageController)
 *    viewController The viewController will appear.
 *    info           A dictionary that includes some infos, such as: `index` / `title`
 */
 ...
 *
 *    pageController The parent controller (WMPageController)
 *    viewController The viewController entirely displayed.
 *    info           A dictionary that includes some infos, such as: `index` / `title`
 */
...
@property (nonatomic, assign) id<WMPageControllerDelegate> delegate;
@property (nonatomic, assign) id<WMPageControllerDataSource> dataSource;

@property (nonatomic, assign) id<WMAddButtonDelegate> addDelegate;
 ...
 *
 *    classes 子控制器的 class，确保数量与 titles 的数量相等
 *    titles  各个子控制器的标题，用 NSString 描述
 *
 *  @return instancetype
 */
