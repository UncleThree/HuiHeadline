...
-(void)example01
{
    ...
    //广告数据请求
    [HHAdNetwork getLaunchAdImageDataSuccess:^(NSDictionary * response) {
...
-(void)example03
{
    ...
    //广告数据请求
    [HHAdNetwork getLaunchAdVideoDataSuccess:^(NSDictionary * response) {
...
-(void)xhLaunchAd:(XHLaunchAd *)launchAd customSkipView:(UIView *)customSkipView duration:(NSInteger)duration
{
    ...
    //设置时间
    [button setTitle:[NSString stringWithFormat:@"自定义%zd",duration] forState:UIControlStateNormal];
}
